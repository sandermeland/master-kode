...
non_batched_mod, x, y, w, d = utils.run_optimization_model(L= L , M = M, H = H, F = F, Ir_hlm= Ir_hlm, Ia_hlm = Ia_hlm,  Va_hm = Va_hm, Vp_h_m =Vp_h_m, Vm_m = Vm_m, R_m = R_m, R_h_l = R_h_l, Fu_h_l = Fu_h_l, Fd_h_l = Fd_h_l, compatible_list = compatible_list, log_filename="non_batched_week_v5.log", model_name= "weekly_model_non_batched")



with open("batched_weekly_results.pkl", 'rb') as file:
        aggregated_results = pickle.load(file)
