...
fcr_d_1_df = preprocess_FCR(fcr_d_1_df_2023, area = area, start_month = start_month, year = year, start_day = start_day, end_month = end_month, end_day = end_day, start_hour = start_hour, end_hour = end_hour)
fcr_d_2_df = preprocess_FCR(fcr_d_2_df_2023, area = area, start_month = start_month, year = year, start_day = start_day, end_month = end_month, end_day = end_day, start_hour = start_hour, end_hour = end_hour)



FCR_D_1_D = ReserveMarket_OLD(name = "FCR_D_1_D", direction = "up",  response_time= 30, duration=15, min_volume=1, sleep_time= 60, activation_threshold= 49.9, price_data= fcr_d_1_df.drop(columns = ["FCR-N Price EUR/MW", "FCR-N Volume MW", "FCR-D Volume MW", "Area"]), volume_data= fcr_d_1_df.drop(columns = ["FCR-N Price EUR/MW", "FCR-N Volume MW", "FCR-D Price EUR/MW", "Area"]))
FCR_D_1_N = ReserveMarket_OLD(name = "FCR_D_1_N", direction = "both", response_time= 30, duration= 15, min_volume=1, sleep_time=60, activation_threshold= 50, price_data= fcr_d_1_df.drop(columns = ["FCR-D Price EUR/MW", "FCR-D Volume MW","FCR-N Volume MW", "Area"]), volume_data= fcr_d_1_df.drop(columns = ["FCR-D Price EUR/MW", "FCR-D Volume MW","FCR-N Price EUR/MW", "Area" ]))

        
FCR_D_2_D = ReserveMarket_OLD(name = "FCR_D_2_D", direction = "up", response_time= 30, duration=15, min_volume=1, sleep_time= 60, activation_threshold= 49.9, price_data= fcr_d_2_df.drop(columns = ["FCR-N Price EUR/MW", "FCR-N Volume MW","FCR-D Volume MW", "Area"]), volume_data= fcr_d_2_df.drop(columns = ["FCR-N Price EUR/MW", "FCR-N Volume MW","FCR-D Price EUR/MW" , "Area"]))
FCR_D_2_N = ReserveMarket_OLD(name = "FCR_D_2_N", direction = "both", response_time= 30, duration= 15, min_volume=1, sleep_time=60, activation_threshold= 50, price_data= fcr_d_2_df.drop(columns = ["FCR-D Price EUR/MW", "FCR-D Volume MW","FCR-N Volume MW", "Area"]), volume_data= fcr_d_2_df.drop(columns = ["FCR-D Price EUR/MW", "FCR-D Volume MW","FCR-N Price EUR/MW" , "Area"]))
...
down_directory = '../master-data/markets-data/a/aFFR/down_2023'
...
updated_afrr_dfs = preprocess_afrr(up_df, down_df, area, year = 2023, start_month= start_month, end_month = end_month, start_day = start_day, end_day = end_day, start_hour= start_hour, end_hour= end_hour)

aFRR_up = ReserveMarket_OLD(name = "aFRR up", direction = "up", response_time = 300, duration = 60, min_volume=1, sleep_time=60, activation_threshold=49.9, price_data = updated_afrr_dfs[0].drop(columns = ["aFRR Volume Up " + area]), volume_data = updated_afrr_dfs[0].drop(columns = ["aFRR Price Up " + area]))
aFRR_down = ReserveMarket_OLD(name = "aFRR down", direction = "down", response_time = 300, duration = 60, min_volume=1, sleep_time=60, activation_threshold=49.9, price_data = updated_afrr_dfs[0].drop(columns = ["aFRR Volume Up " + area]), volume_data = updated_afrr_dfs[0].drop(columns = ["aFRR Price Up " + area]))
...
new_dict = preprocess_rk_dfs_dict(rk_dfs_dict, area=area,start_year= year, end_year = year, start_month = start_month, end_month = end_month, start_day = start_day, end_day = end_day, start_hour = start_hour, end_hour = end_hour)

RK_up = ReserveMarket_OLD(name = "RK_up", direction = "up", response_time=300, duration = 60, min_volume=10,sleep_time=0,activation_threshold=0, price_data= new_dict["price_up"], volume_data= new_dict["volume_up"])

RK_down = ReserveMarket_OLD(name = "RK_down", direction = "down", response_time=300, duration = 60, min_volume=10,sleep_time=0,activation_threshold=0, price_data= new_dict["price_down"], volume_data= new_dict["volume_down"])
...
rkom_df = create_standardized_RKOM_df([rkom_22, rkom_23], year = year, area= area, start_month= start_month, start_day= start_day, start_hour=start_hour, end_month=end_month, end_day= end_day, end_hour= end_hour)


RKOM_H_up = ReserveMarket_OLD(name = "RKOM_H_up", direction = "up", response_time = 300, duration = 60*4, min_volume = 10, sleep_time= 60, capacity_market = True, price_data= rkom_df.drop(columns = ["RKOM-H Volume up", "RKOM-H Volume down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-H Price down"]), volume_data= rkom_df.drop(columns = ["RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Volume down"]))

RKOM_H_down = ReserveMarket_OLD(name = "RKOM_H_down", direction = "down", response_time = 300, duration = 60*4, min_volume = 10, sleep_time= 60, capacity_market = True, price_data= rkom_df.drop(columns = ["RKOM-H Volume up", "RKOM-H Volume down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-H Price up"]), volume_data= rkom_df.drop(columns = ["RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Volume up"]))

RKOM_B_up = ReserveMarket_OLD(name = "RKOM_B_up", direction = "up", response_time = 300, duration = 60, min_volume = 10, sleep_time= 60*8, capacity_market = True, price_data= rkom_df.drop(columns = ["RKOM-H Volume up", "RKOM-H Volume down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price down"]), volume_data= rkom_df.drop(columns = ["RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Volume down"]))

RKOM_B_down = ReserveMarket_OLD(name = "RKOM_B_down", direction = "down", response_time = 300, duration = 60, min_volume = 10, sleep_time = 60*8, capacity_market = True, price_data= rkom_df.drop(columns = ["RKOM-H Volume up", "RKOM-H Volume down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price up"]), volume_data= rkom_df.drop(columns = ["RKOM-H Price up", "RKOM-H Price down", "RKOM-B Price up", "RKOM-B Price down", "RKOM-B Volume up", "RKOM-B Volume down", "RKOM-H Volume up"]))
