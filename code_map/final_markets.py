...
def preprocess_afrr(up_directory : str, down_directory : str,   area : str, start_month : int, year : int, start_day : int, end_month : int, end_day : int, start_hour : int, end_hour: int):
...
def create_afrr_dfs(up_df, down_df, year, start_month, start_day, start_hour, end_month, end_day, end_hour):
    afrr_area_dfs = []
    areas = ['NO1', 'NO2', 'NO3', 'NO4', 'NO5']
    for area in areas:
        afrr_area_dfs.append(preprocess_afrr(up_df, down_df, area, year = year, start_month= start_month, end_month = end_month, start_day = start_day, end_day = end_day, start_hour= start_hour, end_hour= end_hour))
